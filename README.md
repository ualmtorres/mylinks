...
* [Neo4j Posts by Denhan Coder](https://denhamcoder.net/tag/graphdb/)

# Alexa

* [Alexa AWS Setup and Skill Dev Posts by Charlotte Davies](https://planetachatbot.com/@charlotte.davies)
* [Manage Credentials with ASK CLI by Amazon](https://developer.amazon.com/es/docs/smapi/manage-credentials-with-ask-cli.html)
* [Build an Alexa skill that calls an external API - YouTube Video by Dabble Lab](https://www.youtube.com/watch?v=swW8tPRB_J4)
